...
if __name__ == "__main__":
    ...
    try:
        ...
        myvar0 = root.get_child(["0:Objects", "2:MyObject", "2:MyVariable0"])
        myvar1 = root.get_child(["0:Objects", "2:MyObject", "2:MyVariable1"])
        myvar2 = root.get_child(["0:Objects", "2:MyObject", "2:MyVariable2"])
        obj = root.get_child(["0:Objects", "2:MyObject"])
        while True:
            #print("myvar0 is: ", myvar0)
            #print("myvar1 is: ", myvar1)
            #print("myvar2 is: ", myvar2)
            #print("myobj is: ", obj)
            #print(myvar0.get_value())
            #print(myvar1.get_value())
            #print(myvar2.get_value())

            print(f"1er variable: nom={myvar0}, nom={obj.get_browse_name()}, valeur={myvar0.get_value()}")
            print(f"2e  variable: nom={myvar1}, nom={obj.get_browse_name()}, valeur={myvar1.get_value()}")
            print(f"3e  variable: nom={myvar2}, nom={obj.get_browse_name()},  valeur={myvar2.get_value()}")
